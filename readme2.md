...
* **Input File:** `4118e166-34f5-4c1f-9eed-c64b90a3dace.h5ad` (Raw large-cohort file)
* **Output Artifacts:** `SLE_pDC_Cleaned_For_pySCENIC.h5ad`, `01_Global_Type1_IFN_Production.pdf`

### `02_pyscenic_grn_inference.py`
Executes machine learning gene regulatory network inference via GRNBoost2 and RcisTarget.
* **Input Files:** `SLE_pDC_Cleaned_For_pySCENIC.h5ad`, `hs_hgnc_tfs.txt`, `hg38__refseq-r80...feather`, `motifs-v9-nr...tbl`
* **Output Artifacts:** `SLE_pDC_pySCENIC_Complete.h5ad`, `Table_S1_Regulons_Raw.csv`, `IRF7_Target_Genes.txt`

### `03_go_pathway_enrichment.py`
Performs Gene Ontology pathway enrichment testing for the IRF7 regulon.
* **Input File:** `IRF7_Target_Genes.txt`
* **Output Artifacts:** `Table_S2_GO_Enrichment.csv`, `Figure_2_IRF7_GO_Enrichment.pdf`
...
* **Input File:** ENCODE PBMC ATAC-seq data (Auto-fetched via API)
* **Output Artifacts:** `04_SOX4_Motifs.csv`, `Figure_S4_ATAC_Motif_Footprint.pdf`
...
* **Output Artifacts:** Console correlation metrics, `Figure_4_Pseudotime_Dynamics.pdf`

### `06_liana_cell_communication.py`
Maps ligand-receptor interaction networks signaling into the pDC target cells.
* **Input File:** `4118e166-34f5-4c1f-9eed-c64b90a3dace.h5ad`
* **Output Artifacts:** `LIANA_Full_Results.csv`, `pDC_CXCR4_Interactions.csv`
...
* **Input File:** `SLE_pDC_pySCENIC_Complete.h5ad`
* **Output Artifacts:** Console statistical readouts, `Figure_5_Bootstrapping_Power_Analysis.pdf`
...
* **Output Artifacts:** `Fig1A_Network_vs_Gene_Validation.pdf`, `Fig1B_Top_SLE_Regulons_Dotplot.pdf`, `Supplementary_FigS1_Harmony_Integration.pdf`
